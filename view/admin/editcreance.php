<?php
    ...
    require_once '../../model/update-creance.php'; 
?>
<!doctype html>
                        ...
                        <form action="" method="post" class="appointment-form">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-wrap">
                                        <div class="icon"><span class="ion-md-calendar"></span></div>
                                        <label>Montant Payer(CDF):</label>
                                         <input type="number" class="form-control appointment_date-check-in" placeholder="Montant Payer" name="montant_payer" required="required" value="<?= $userinfo['montant_payer'] ?>">
                                    </div>
                                </div>
                                </div>
                                 <div class="col-md-6">
                                    ...
                                    <div class="input-wrap">
                                        ...
                                        <label>Description:</label>
                                         <textarea type="text" class="form-control appointment_date-check-in" placeholder="Description Opération Facture" name="description" required="required"><?= $userinfo['description'] ?></textarea>
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-wrap">
                                        <div class="icon"><span class="ion-md-calendar"></span></div>
                                         <button type="submit" name="saves" class="btn btn-success col-lg-12">Editer</button>
                                    </div>
                                </div>
                                </div>
                            </div>
