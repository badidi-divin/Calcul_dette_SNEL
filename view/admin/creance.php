    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            <?php
                ...
                require_once '../../model/select-creance.php';
?>
        <div class="col-md-12 col-xd-12" style="padding-top: 80px;padding-bottom: 30px;">
            <form method="get" action="" class="form-inline">
                        ...
                        &nbsp;&nbsp;
                        <a href="add_creance.php" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span></a>
                         &nbsp;&nbsp;
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div class="table-responsive table--no-card m-b-30">
                                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                                ...
                                                <thead>
                                       <tr>
                                         <th>ID</th><th>CODE-ABONNE</th><th>NUM-FACTURE</th><th>MONTANT-A-PAYER(CDF)</th><th>MONTANT-PAYER(CDF)</th><th>RESTE</th><th>DESCRIPTION</th><th>DATE-OPERATION</th><th>ACTIONS</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                       ...
                                       <td ><?php  echo($et['id'])?></td>
                                        ...
                                        <!--liens -->
                                        <td style="background-color: white; font-size: 5px;"><a onclick="return confirm('Etes-vous sûre...?');" href="../model/Supprimecreance.php?id=<?php echo($et['id'])?>" class='btn btn-danger'><span class="glyphicon glyphicon-trash"></span></a>
                                            <td style="background-color: white; font-size: 5px;"><a  href="editcreance.php?id=<?php echo($et['id'])?>" title="Editer cet enregistrement" class='btn btn-success'><span class="glyphicon glyphicon-pencil"></span></a>
                                        </td>
                                                    </tr>   
                                            <?php $c++; } ?>  
                                    </tbody>
