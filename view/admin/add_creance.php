<?php
    ...
    require_once '../../model/insert-creance.php'; 
?>
<!doctype html>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-wrap">
                                        ...
                                        <label>Montant Payer(CDF):</label>
                                         <input type="number" class="form-control appointment_date-check-in" placeholder="Montant Payer" name="montant_payer" required="required">
                                    </div>
                                </div>
                                </div>
                                 <div class="col-md-6">
                                    ...
                                    <div class="input-wrap">
                                        ...
                                        <label>Description:</label>
                                         <textarea type="text" class="form-control appointment_date-check-in" placeholder="Description Opération Facture" name="description" required="required"></textarea>
                                    </div>
                                </div>
                                </div>
